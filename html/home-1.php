	...
	<div class="container">
		<header><br><br><br><br>
			...
			<div class="heading">
				...
				<div>
					<a href="#"><img src="images/android.png" alt="android link"></a>
					<a href="#"><img src="images/app-store.png" height="65" width="200" alt="android link"></a>
				</div><br><br><br>
				<div class="for-user">
			...
			<div class="content">
				...
				<div class="row">
					...
					<div class="col-sm-6 col-sm-pull-6">
						...
						<p>Visual analytics offering deeper insights  to improve governance. Per constituency/colony based map view to locate problems.</p>
					</div>
				</div>
			</div>
		</div>
